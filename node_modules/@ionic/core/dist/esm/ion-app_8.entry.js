 ...
 */
import { r as registerInstance, e as config, f as printIonWarning, h, d as Host, g as getElement, c as createEvent, a as readTask, i as forceUpdate, w as writeTask, j as printIonError } from './index-C23AVPx9.js';
import { shouldUseCloseWatcher } from './hardware-back-button-DmkiRgOT.js';
import { a as isPlatform, b as getIonMode } from './ionic-global-ZXjCXKH0.js';
import { i as inheritAriaAttributes, h as hasLazyBuild, c as componentOnReady, e as clamp, s as shallowEqualStringMap } from './helpers-BSmc0nst.js';
import { i as isRTL } from './dir-Dojwmvde.js';
import { h as hostContext, c as createColorClasses } from './theme-byZM6qHV.js';
import { b as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-C1b9CLFg.js';
import { c as createKeyboardController } from './keyboard-controller-DEwoa1ev.js';
import { g as getTimeGivenProgression } from './cubic-bezier-hHmYLOfE.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-BwNhx9NR.js';
import { c as createLockController } from './lock-controller-B-hirT0v.js';
import { t as transition } from './index-DnA_7Bnx.js';
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./index-CJln0gS3.js').then((module) => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-Cv9gb3ja.js').then((module) => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    ...
                    import('./input-shims-Dqk-Ou25.js').then((module) => module.startInputShims(config, platform));
                }
                const hardwareBackButtonModule = await import('./hardware-back-button-DmkiRgOT.js');
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-B2CmabKY.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
