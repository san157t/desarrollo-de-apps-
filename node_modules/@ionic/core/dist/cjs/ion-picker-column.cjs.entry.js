...
var haptic = require('./haptic-Ch-X4gRx.js');
...
const PickerColumn = class {
    constructor(hostRef) {
        ...
        this.watchForOutsidePress = () => {
            index$1.doc?.addEventListener('pointerdown', this.onPointerDownOutside, { capture: true });
        };
        this.stopWatchingForOutsidePress = () => {
            index$1.doc?.removeEventListener('pointerdown', this.onPointerDownOutside, { capture: true });
        };
        /**
