...
var keyboard = require('./keyboard-cHxZlTyz.js');
...
const createKeyboardController = async (keyboardChangeCallback) => {
    ...
    const init = async () => {
        ...
        index.win?.addEventListener('keyboardWillShow', keyboardWillShowHandler);
        index.win?.addEventListener('keyboardWillHide', keyboardWillHideHandler);
    };
    ...
    const destroy = () => {
        index.win?.removeEventListener('keyboardWillShow', keyboardWillShowHandler);
        index.win?.removeEventListener('keyboardWillHide', keyboardWillHideHandler);
