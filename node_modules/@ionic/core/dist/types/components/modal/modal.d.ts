...
export declare class Modal implements ComponentInterface, OverlayInterface {
    ...
    private resetSheetContentScroll?;
    ...
    private unsubscribeRootSafeAreaTop?;
     ...
     */
    ionDragMove: EventEmitter<ModalDragEventDetail>;
    /**
     * Event that is emitted when the sheet modal or card modal gesture ends.
     */
    ionDragEnd: EventEmitter<ModalDragEventDetail>;
     ...
     */
    private restoreSafeAreaOverrides;
    render(): any;
}
